    ...
    Card(
        ...
        Column(
            ...
            WeatherCardGrid(weatherInfoList = listOf(
                ...
                WeatherInfo("Temperature", homeScreenUiState.weatherPointInTime.temperature, "℃", painterResource(id = R.drawable.dewpoint)),
                WeatherInfo("Cloudiness", homeScreenUiState.weatherPointInTime.cloudFraction, "%", painterResource(id = R.drawable.cloudfraction)),
